	...
	<div id="myCarousel" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="item active">
				      <img
					src="C:/Users/lgonzdia/eclipse-workspace/SpringHelloWorld/src/main/webapp/resources/core/images/wall1.jpg"
					alt="New York">      
			...
			<div class="item">
				      <img
					src="C:/Users/lgonzdia/eclipse-workspace/SpringHelloWorld/src/main/webapp/resources/core/images/wall2.jpg"
					alt="Chicago">      
				<div class="carousel-caption">
					       
					<h3>Chicago</h3>
	...
	font-style: italic;
		...
		<div class="row text-center">
			...
			<div class="col-sm-4">
				...
				<div class="thumbnail">
					      <img
						src="C:/Users/lgonzdia/eclipse-workspace/SpringHelloWorld/src/main/webapp/resources/core/images/cover1.jpg"
						alt="Paris">      
					<p>
						<strong>Paris</strong>
					</p>
						...
						<form role="form">
							...
							<div class="form-group">
								            <label for="psw"><span
									...
									per person</label>             <input type="number"
